...
ActiveRecord::Schema.define(:version => 20130909203622) do
  ...
  add_index "follows", ["twitter_follower_id", "twitter_followee_id"], :name => "index_follows_on_twitter_follower_id_and_twitter_followee_id"
